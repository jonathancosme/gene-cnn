...
run_name = 'resnet-smaller-3-1D-3w-alt'
description = 'resnet smaller 3; 1D filter; window_size=3; no maxpool; first stride=1; 10% data; 100% labels; species only'
...
with mirrored_strategy.scope():
    ...
    outputs = tf.keras.layers.Conv2D(first_filter_size, (1, 3), padding='same', strides=1, activation=None)(inputs)
